...
#define NBDATA 4 //nombre de donné traité 
...
#define NBCOUCHE 4 //nombre de couche du reseaux
#define NBENTREE {NBPARAM,3,2,3,1} //nombre de neurone par couche / nombre d'entré par neurone
